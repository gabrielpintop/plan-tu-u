        ...
        <li className="list-group-item">
          <div className="row">
            <div className="col-md-9 col-12">
              ...
              <p>
                <b>Puntos asignados: {this.state.puntosAsignados} </b>
                (el {this.state.fechaCreacion.substring(0, 10)} a las{' '}
                {this.state.fechaCreacion.substring(11, 20)}
      ...
      return (
        <li className="list-group-item">
          <p>
            ...
            {this.state.descripcion}
            <br />¡ Ganaste{' '}
            <b className="text-uniandes">{this.state.puntosAsignados}</b> puntos
            por esta actividad !
          </p>
        </li>
      );
